...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    group: "games",
    present: "牛来 · 猪飞",
    note: "Playable demos on this garden. Waiting tree, hand-cast oracle, Handcrafted Post Office, Fun AI / dseek Life.",
    embeddable: false,
    embedSrc: "/game",
  },
  {
    ...
    items: [
      {
        ...
        path: "ichina.co/game",
        live: true,
        note: "Playable demos: waiting tree, hand-cast oracle, Handcrafted Post Office, Fun AI / dseek Life. Not the live Three.js planet.",
      },
    ],
  },
  {
